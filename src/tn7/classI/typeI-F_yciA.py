...
rs = RuleSet().require('tnsB').require('tnsA').require('tniQ').require('cas7',regex=True).require('cas6',regex=True).require('yciA').max_distance('tnsA', 'tnsB', 2000,closest_pair_only=True).max_distance('tnsA', 'yciA', 2000,closest_pair_only=True)

...
rs = RuleSet().require('tnsB',regex=True).require('cas7',regex=True).require('cas6',regex=True).require('tnsA',regex=True).require('tniQ').max_distance('tnsA', 'tnsB', 2000,closest_pair_only=True)
